...
export const mainMenuButton = '[id="main-menu-button"]';
export const productCategory = '[href="/en/hair-care/combs"]';
export const subProductCategory = '[title="UV"]';
export const firstProduct = '[href="/en/hair-care/combs/ibero-detangling-comb"]';
